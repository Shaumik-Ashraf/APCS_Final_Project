...
public class Monster extends GChar{
    ...
    public static void initMonsters()
    {
        ...
        bestiary.put ("Sorcerer", new String[]         {"Sorcerer",         "Dark",    "Brain Shock",   "Arcanite Force",    ".3",      ".1",   "1.4" ,    "10",    ".9"   });
        ...
        bestiary.put ("Sword Beetle", new String[]     {"Sword Beetle",     "Wood",   "Strong Swing",   "Proud Swivel",      ".7",     "1.5",    ".7" ,    "10",   "1.4"   });
        ...
        bestiary.put ("Future Fencer", new String[]    {"Future Fencer",    "Dark",   "Finishing Touch","Darkness",          ".1",     "1.7",    "1.5",    "10",   "1.6"   });
