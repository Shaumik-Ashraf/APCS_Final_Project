/* Skill classes
I'm modifying this from max's version - SA
packaging into gameskills dir

I commented out Rogue skills, empty skills, light skills, and dark skills for now...
*/
...
public abstract class Skill {
    ...
    public static void activateSkill(gChar user, gChar target, String skill) {
		if( user.SkillSet.indexOf(skill)!=-1 ) {  //if user knows skill
			(allSkills.get(skill)).use(user,target);
		}
		else {
			System.out.print(skill + " is unknown.\n");
		}
	}
...
class arrowStrom extends Skill
{
    ...
    public void use (gChar user, gChar c){
        ...
        while (hits != 0)
        {
            Skill.activateSkill(user, c, "Basic Attack");
            hits --;
        }
...
class arcaneBullets extends Skill
{
    ...
    public void use (gChar user, gChar c){
        ...
        while (hits != 0)
        {
            Skill.activateSkill(user, c, "Basic AttackM");
            hits --;
        }
